...
func TestBootConfigFile(t *testing.T) {
	...
	util.BootConfigFile(file, buf, "172.16.100.2", "00-50-56-82-72-8d")
	real := buf.String()
	expected := `bootstate=0
title=Loading ESXi installer
timeout=5
prefix=01-00-50-56-82-72-8d/images
kernel=/b.b00
kernelopt=ks=http://172.16.100.2/kickstart/00-50-56-82-72-8d/ks.cfg
